...
#define SHKMyAppName			@"Dr.Ape"
#define SHKMyAppURL				@"http://bit.ly/DrApe"
 ...
 */
#define SHKTwitterConsumerKey		@"jVjbjGUuS6A9eyYw8RpizA"
#define SHKTwitterSecret			@"8P4sbIDzLGnGAzbJxlsHJcJpWEByv24i5rNOiCcoyA"
#define SHKTwitterCallbackUrl		@"http://callback.laststar.eu" // You need to set this if using OAuth, see note above (xAuth users can skip it)
